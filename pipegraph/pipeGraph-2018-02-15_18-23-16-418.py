...
class ColumnSelector(BaseEstimator):
    """ Slice X data in columns adding each column name
    Parameters
    ----------
    mapping : range of integers for the powering operation
    """
    ...
    def predict(self, X):
        ...
        Returns
        -------
        returns a list with column name and its column value.
        """
...
class CustomPower(BaseEstimator):
    """ Power X data to values defined such as range as parameter
    Parameters
    ----------
    ...
    def predict(self, X):
        ...
        Returns
        -------
        X : power operation for each integer value in the input range
        """
