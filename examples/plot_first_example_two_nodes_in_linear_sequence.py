...
###############################################################################
# This example described the basic configuration of a :class:`PipeGraphRegressor`. The following examples show more elaborated cases in order of increasing complexity.
